...
######################################################
    ...
    #####################################################
        ...
        ### get parameters #### 
        self.Kp = rospy.get_param('~Kp',10) #rango en que varia el controldaor
        self.Ki = rospy.get_param('~Ki',10) #""
        self.Kd = rospy.get_param('~Kd',0.001) #""
        self.out_min = rospy.get_param('~out_min',-255) #controla la velocidad final
        self.out_max = rospy.get_param('~out_max',255) #controla la velocidad final
        self.rate = rospy.get_param('~rate',40)
        self.rolling_pts = rospy.get_param('~rolling_pts',2)
        self.timeout_ticks = rospy.get_param('~timeout_ticks',2)
        self.ticks_per_meter = rospy.get_param('ticks_meter', 670)
    ...
    #####################################################
        ...
        #self.integral = (self.previous_error + self.error) * pid_dt
